...
let CountdownFeedback = require('./CountdownFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CountdownActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CountdownFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CountdownFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CountdownActionFeedback(null);
    ...
    data.feedback = CountdownFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CountdownActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CountdownFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CountdownFeedback()
    }
...
module.exports = CountdownActionFeedback;
