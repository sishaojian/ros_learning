...
let CountdownGoal = require('./CountdownGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CountdownActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CountdownGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CountdownActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CountdownGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CountdownGoal()
    }
...
module.exports = CountdownActionGoal;
